            ...
            if (publisherName == null && cscFile != null) {
                if (process.platform === "win32") {
                    try {
                        ...
                        const commonName = subject == null ? null : (0, (_rfc2253Parser || _load_rfc2253Parser()).parseDn)(subject).get("CN");
                        if (commonName) {
    ...
    sign(file, logMessagePrefix) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            yield _this3.doSign({
                ...
                options: Object.assign({}, _this3.platformSpecificBuildOptions, { certificateSubjectName: cscInfo.subjectName, certificateSha1: cscInfo.certificateSha1 })
            });
        })();
    }
...
const debugOpenssl = (0, (_debug2 || _load_debug()).default)("electron-builder:openssl");