...
function _load_nsisPackage() {
    return _nsisPackage = require("./nsisPackage");
}
    ...
    buildAppPackage(appOutDir, arch) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            if (options.differentialPackage) {
                yield (0, (_nsisPackage || _load_nsisPackage()).createDifferentialPackage)(archiveFile, archiveOptions, packager);
            }
            return archiveFile;
        })();
    }
                ...
                yield (_bluebirdLst2 || _load_bluebirdLst2()).default.map(_this4.archs.keys(), (() => {
                    var _ref = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (arch) {
                        ...
                        if (_this4.isWebInstaller) {
                            ...
                            packageFiles[(_builderUtil || _load_builderUtil()).Arch[arch]] = file;
                        }
                    });
    ...
    configureDefines(oneClick, defines) {
        ...
        if (options.differentialPackage) {
            asyncTaskManager.add((0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
                ...
                const s7File = _path.join((yield nsisResourcePathPromise.value), "ia32", "7za.exe");
                defines.SEVEN_ZIP_FILE = s7File;
                yield packager.sign(s7File);
            }));
        }
