...
let reportError = exports.reportError = (() => {
    ...
    return function reportError(_x2, _x3, _x4, _x5, _x6) {
...
let downloadCertificate = exports.downloadCertificate = (() => {
    ...
    return function downloadCertificate(_x7, _x8, _x9) {
...
let removeKeychain = (() => {
    ...
    return function removeKeychain(_x10) {
        return _ref4.apply(this, arguments);
    };
})();

let createKeychain = exports.createKeychain = (() => {
    var _ref5 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (_ref6) {
        let tmpDir = _ref6.tmpDir,
            cscLink = _ref6.cscLink,
            cscKeyPassword = _ref6.cscKeyPassword,
            cscILink = _ref6.cscILink,
            cscIKeyPassword = _ref6.cscIKeyPassword,
            currentDir = _ref6.currentDir;
        ...
        if (!(list.indexOf(keychainFile) !== -1)) {
    ...
    return function createKeychain(_x11) {
        return _ref5.apply(this, arguments);
    };
})();

let importCerts = (() => {
    var _ref7 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (keychainName, paths, keyPasswords) {
    ...
    return function importCerts(_x12, _x13, _x14) {
...
let getValidIdentities = (() => {
    var _ref8 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (keychain) {
    ...
    return function getValidIdentities(_x15) {
        return _ref8.apply(this, arguments);
    };
})();

let _findIdentity = (() => {
    var _ref9 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (type, qualifier, keychain) {
    ...
    return function _findIdentity(_x16, _x17, _x18) {
...
function isSignAllowed() {
    let isPrintWarn = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
