...
let build = exports.build = (() => {
    var _ref = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (rawOptions) {
        ...
        if (options.draft === undefined && !(0, (_builderUtil || _load_builderUtil()).isEmptyOrSpaces)(process.env.EP_DRAFT)) {
            options.draft = process.env.EP_DRAFT.toLowerCase() === "true";
        }
        if (options.prerelease === undefined && !(0, (_builderUtil || _load_builderUtil()).isEmptyOrSpaces)(process.env.EP_PRELEASE)) {
